...
```bash
INIT=$(node "/home/vsman/agents-room/.gemini/get-shit-done/bin/gsd-tools.cjs" init map-codebase)
...
```bash
node "/home/vsman/agents-room/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
