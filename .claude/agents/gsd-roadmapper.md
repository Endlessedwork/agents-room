...
Reference full template: `/home/vsman/agents-room/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/vsman/agents-room/.claude/get-shit-done/templates/state.md`.
